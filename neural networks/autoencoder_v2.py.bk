...
plt.grid()
plt.plot(np.arange(0, 8, 1), np.ravel(x_normal.loc[0:0, :]))
plt.title("A Normal Sound")
plt.show()
plt.plot(np.arange(0, 8, 1), np.ravel(x_abnormal.loc[0:0, :]))
plt.title("An Abnormal Sound")
plt.show()
